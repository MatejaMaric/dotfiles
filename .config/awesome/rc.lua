...
for i = 1, #my_tags do
    globalkeys = gears.table.join(globalkeys,
        ...
        awful.key({ modkey }, my_tags[i],
                  ...
                  {description = "view tag "..my_tags[i], group = "tag"}),
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, my_tags[i],
                  function ()
                      if client.focus then
                  ...
                  {description = "move focused client to tag "..my_tags[i], group = "tag"})
    )
end
